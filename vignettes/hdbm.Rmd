...
devtools::install_packages("umich-cphds/hdbm", built_opts = c())
```
...
[Rtools](https://cran.r-project.org/bin/windows/Rtools/) and on macOS,
...
intercept. In a real world situation, it may be beneficial to normalize the
input data.
```{r}
...
set.seed(12345)
# burn = 3000 just for this example. It is recommended to pick a larger number.
